...
// Fetch subject details and associated teachers
$subject_qry = $conn->query("SELECT * FROM subject_list WHERE id = $subject_id");
$subject = $subject_qry->fetch_assoc();

// Updated query to select the id from the subject_teacher table (which is the actual ID for deletion)
...
function delete_subject(id) {
    $.ajax({
        ...
        method: 'POST',
        data: { id: id }, // The ID being passed here is the subject_teacher_id
